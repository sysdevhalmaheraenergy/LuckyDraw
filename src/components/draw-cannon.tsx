    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center gap-8 px-6">
        ...
        >
          {/* make image bigger */}
          <div
            className={`w-full max-w-lg md:max-w-2xl rounded-3xl flex flex-col items-center justify-center gap-6 md:gap-8 bg-linear-to-br ${prizeColor} overflow-hidden`}
            style={{
              boxShadow:
          ...
          >
            {winningPrize.imageUrl ? (
              <div className="flex items-center justify-center w-full flex-1 min-h-48">
                <img
                  src={winningPrize.imageUrl}
                  alt={winningPrize.name}
                  className="h-auto w-auto max-h-64 md:max-h-96 max-w-full rounded-2xl object-contain"
                  style={{
              ...
              <div className="text-7xl md:text-8xl drop-shadow-lg flex-1 flex items-center justify-center">
                {prizeEmoji}
              </div>
            )}
            <div className="text-white font-black text-2xl md:text-3xl tracking-wide text-center px-3 w-full"
              style={{
